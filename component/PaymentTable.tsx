...
const getTotalCoverage = ({ values }: UseFormReturnType<PaymentType>) => {
  return (
    values.coverages_TPL +
    values.coverages_lossAndDamage +
    values.coverages_propertyDamage +
    values.coverages_bodilyInjury +
    values.coverages_APPA +
    (values.coverages_AOG || 0)
  );
};
...
const getTotalPremiums = ({ values }: UseFormReturnType<PaymentType>) => {
  return (
    values.premiums_TPL +
    values.premiums_lossAndDamage +
    values.premiums_propertyDamage +
    values.premiums_bodilyInjury +
    values.premiums_APPA +
    (values.premiums_AOG || 0)
  );
};
      ...
      <Table my={20}>
        ...
        <tbody>
          <tr>
            <td>TPl</td>
            <td>
              <NumberInput size='xs' {...form.getInputProps('coverages_TPL')} />
            </td>
            <td>
              <NumberInput size='xs' {...form.getInputProps('premiums_TPL')} />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <NumberInput
                size='xs'
                {...form.getInputProps('coverages_lossAndDamage')}
              />
            </td>
            <td>
              <NumberInput
                size='xs'
                {...form.getInputProps('premiums_lossAndDamage')}
              />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <NumberInput
                size='xs'
                {...form.getInputProps('coverages_bodilyInjury')}
              />
            </td>
            <td>
              <NumberInput
                size='xs'
                {...form.getInputProps('premiums_bodilyInjury')}
              />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <NumberInput
                size='xs'
                {...form.getInputProps('coverages_APPA')}
              />
            </td>
            <td>
              <NumberInput size='xs' {...form.getInputProps('premiums_APPA')} />
            </td>
          </tr>
          <tr>
            <td>AOG</td>
            <td>
              {form.values.coverages_AOG && (
                <NumberInput
                  size='xs'
                  {...form.getInputProps('coverages_AOG')}
                />
              )}
            </td>
            <td>
              {form.values.premiums_AOG && (
                <NumberInput
                  size='xs'
                  {...form.getInputProps('premiums_AOG')}
                />
              )}
            </td>
          </tr>
          <tr style={{ backdropFilter: 'brightness(.9)' }}>
            ...
            <td>
              <Text> {totalCoverage} </Text>
            </td>
            <td>
              <Text> {totalPremiums} </Text>
            </td>
          </tr>
        </tbody>
      </Table>
